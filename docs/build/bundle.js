...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	let current;
    	const switch_instance_spread_levels = [/*item*/ ctx[0].component.props, { toastId: /*item*/ ctx[0].id }];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(switch_instance_spread_levels, [
    					get_spread_object(/*item*/ ctx[0].component.props),
    					{ toastId: /*item*/ ctx[0].id }
    				])
    			: {};
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 89, 2, 2177);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(progress_1, file$4, 92, 2, 2283);
    ...
    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-13r07im-style";
    	style.textContent = "ul.svelte-13r07im{top:var(--toastContainerTop,1.5rem);right:var(--toastContainerRight,2rem);bottom:var(--toastContainerBottom,auto);left:var(--toastContainerLeft,auto);position:fixed;margin:0;padding:0;list-style-type:none;pointer-events:var(--toastContainerPointerEvents, auto);z-index:9999}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(li, file$3, 34, 2, 803);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!li_intro) li_intro = create_in_transition(li, fly, /*item*/ ctx[5].intro);
    				li_intro.start();
    			});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$3, 32, 0, 762);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SvelteToast extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-13r07im-style")) add_css$1();
    ...
    ********************************************** */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*toastId*/ 2) set_data_dev(t3, /*toastId*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { foo } = $$props;
    	let { toastId } = $$props;
    	const writable_props = ["foo", "toastId"];
    	...
    	$$self.$capture_state = () => ({ foo, toastId });
    ...
    class Dummy extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { foo: 0, toastId: 1 });
    ...
    function add_css() {
    	var style = element("style");
    	style.id = "svelte-ate7cy-style";
    	style.textContent = ".colors.svelte-ate7cy{--toastBackground:rgba(255,255,255,0.95);--toastColor:#424242;--toastProgressBackground:aquamarine}.bottom.svelte-ate7cy{--toastContainerTop:auto;--toastContainerRight:auto;--toastContainerBottom:8rem;--toastContainerLeft:calc(50vw - 8rem)}.top.svelte-ate7cy{--toastContainerTop:0.5rem;--toastContainerRight:2rem;--toastContainerBottom:auto;--toastContainerLeft:2rem;--toastWidth:100%;--toastMinHeight:1.5rem;--toastBackground:rgba(59,130,246,0.95);--toastMsgPadding:0.25rem 0.5rem;font-size:0.875rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    // (288:6) <Prism classes="w-full h-full bg-gray-700 text-gray-200 font-mono shadow rounded-sm overflow-scroll p-4">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(288:6) <Prism classes=\\\"w-full h-full bg-gray-700 text-gray-200 font-mono shadow rounded-sm overflow-scroll p-4\\\">",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 295, 6, 7156);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(295:6) {#each buttons as btn}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const handleClick = btn => {
    		...
    		btn.run();
    		gtag("event", `toast:${camelCase$1(btn.name)}`);
    	};
...
toast.pop(0)`,
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-ate7cy-style")) add_css();
